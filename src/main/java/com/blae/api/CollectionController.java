...
public class CollectionController {
    ...
    public ResponseEntity<List<CollectionDTO>> getCollectionsByUser(@PathVariable Integer userId) {
        System.out.println("Getting collections for user: " + userId);
        List<CollectionDTO> collections = collectionService.getCollectionsByUserWithCount(userId);
        System.out.println("Collections found: " + (collections != null ? collections.size() : "null"));
